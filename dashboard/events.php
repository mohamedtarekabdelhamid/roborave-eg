...
if (isset($_POST['name'])) {
  ...
  if (empty($name) || empty($starting_date) || empty($ending_date) || empty($event_link)) {
    ...
    $result = insertEvent($name, $starting_date, $ending_date, $event_link, $user_id);
    if ($result) {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php endif ?>
          ...
          <form action="events.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="event-link" placeholder="Enter ...">
              </div>
        ...
        <a href="all_events.php" class="ml-2">View all events</a>
