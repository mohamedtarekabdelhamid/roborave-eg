...
if (isset($_POST['description'])) {
  ...
  $video = addslashes(explode('=', $_POST['video'])[1]);
          ...
          <form action="about.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="video" placeholder="Enter ..." value="https://www.youtube.com/watch?v=<?= $current_data['video']; ?>">
              </div>
            </div>
            <!-- /.card-body -->
